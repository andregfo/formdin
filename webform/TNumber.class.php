...
class TNumber extends TEdit
{
	...
	public function show($print=true)
	{
		...
		{
			$this->addEvent('onBlur', "fwChkMinMax(". (is_numeric($this->getMinValue()) ? $this->getMinValue() : "Number.NaN").",".(is_numeric($this->getMaxValue()) ? $this->getMaxValue() : "Number.NaN").",'".$this->getName()."',".$this->getDecimalPlaces().",".$this->getAllowZero().",".$this->getAllowNull().")");
