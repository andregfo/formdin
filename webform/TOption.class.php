...
abstract class TOption extends TControl
{
		...
		if( $this->getFieldType() == 'radio' || $this->getFieldType() == 'check' )
		{
			...
			if( is_array( $this->getOptions() ) )
			{
				...
				foreach( $this->getOptions() as $k=>$v )
				{
					...
					{
						$cell->setcss( 'border-right', '1px solid #c0c0c0' );
					}
		...
		else
		{
			...
			if( is_array( $this->getOptions() ) )
			{
				...
				foreach( $this->getOptions() as $k=>$v )
				{
					...
					{
						if( html_entity_decode( ( string ) $k ) == html_entity_decode( ( string ) $this->getValue() ) )
						{
	...
	public function validate()
	{
		...
		{
			if( ( is_array( $this->getValue() ) && count( $this->getValue() ) == 0 ) || is_null( $this->getValue() ) || $this->getValue() == '' )
			{
