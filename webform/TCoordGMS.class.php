...
class TCoordGMS extends TGroup
{
	...
	public function __construct($strName, $boolRequired=null, $floatLatY=null, $floatLonX=null, $strFieldNameLat=null, $strFieldNameLon=null, $strLabels=null, $strSymbols=null, $intSymbolsFontSize=null, $intMapHeight=null, $intMapWidth=null, $strMapHeaderText=null, $strMapHeaderFontColor=null, $strMapHeaderFontSize=null,$strJsMapCallback=null,$intMapZoom=null)
	{
		...
		$this->latGrau = $this->addNumberField($this->getId() . '_lat_grau', "Latitude&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $labels[0], 4, $boolRequired, 0, true, null, 0, 35, false, null, true, true);
		$this->latGrau->setExampleText('<span style="font-size:' . $intSymbolsFontSize . 'px;">' . $symbols[0] . '</span>');
		$this->latGrau->setProperty('title', 'Intervalo válido - Grau: 0º a 35º');
		$this->latMin = $this->addNumberField($this->getId() . '_lat_min', $labels[1], 4, $boolRequired, 0, false, null, 0, 59, false, null, true);
		...
		// longitude
		$this->lonGrau = $this->addNumberField($this->getId() . '_lon_grau', "Longitude&nbsp;&nbsp;" . $labels[0], 4, $boolRequired, 0, true, null, 30, 70, false, null, false, true);
		$this->lonGrau->setProperty('title', 'Intervalo válido - Grau: 30º a 70º');
		$this->lonGrau->setExampleText('<span style="font-size:' . $intSymbolsFontSize . 'px;">' . $symbols[0] . '</span>');
		$this->lonMin = $this->addNumberField($this->getId() . '_lon_min', $labels[1], 4, $boolRequired, 0, false, null, 0, 59, false, null, true);
...
//            $this->getButtonGMap()->setOnClick('fwFieldCoordShowMap("'.$this->getId().'","'.$this->getMapHeight().'","'.$this->getMapWidth().'","'.$params.'")');
	...
	{
		$zoom = ( ( $this->getLatGrau() && $this->getLonGrau() ) ? 12 : 6 );
