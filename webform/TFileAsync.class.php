...
class TFileAsync extends TEdit
{
	...
	* @return TFileAsync
	*/
	public function __construct($strName,$intSize=null,$boolRequired=null,$strAllowedFileTypes=null,$strMaxSize=null,$intWidth=null,$strJsCallBack=null)
	{
	...
	*/
	public function show($print=true)
	{
       ...
       if( $indexFileName )
       {
           $iframe->setProperty('src',$this->getIndexFileName().'?ajax=1&modulo='.$this->getBase().'includes/upload.php&readOnly='.$boolReadOnly.'&name='.$this->getId().'&tamanhoMaxAlert='.$this->maxSize.'&tamanhoMaxBytes='.$this->getMaxSize().'&callBack='.$this->jsCallBack);
       }
       else
       {
           $iframe->setProperty('src',$this->getBase().'includes/upload.php?readOnly='.$boolReadOnly.'&name='.$this->getId().'&tamanhoMax='.$this->maxSize.'&callBack='.$this->jsCallBack);
       }
	...
	*/
	...
	{
		$maxSize = ereg_replace('[^0-9]','',$this->maxSize);
